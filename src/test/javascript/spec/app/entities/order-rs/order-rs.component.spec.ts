...
import { OrderRsComponent } from 'app/entities/order-rs/order-rs.component';
import { OrderRsService } from 'app/entities/order-rs/order-rs.service';
import { OrderRs } from 'app/shared/model/order-rs.model';

describe('Component Tests', () => {
  describe('OrderRs Management Component', () => {
    let comp: OrderRsComponent;
    let fixture: ComponentFixture<OrderRsComponent>;
    let service: OrderRsService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RsTestModule],
        declarations: [OrderRsComponent],
        providers: [
          {
        ...
        .overrideTemplate(OrderRsComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(OrderRsComponent);
