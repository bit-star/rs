...
describe('Service Tests', () => {
  describe('PhotoRs Service', () => {
    let injector: TestBed;
    let service: PhotoRsService;
    let httpMock: HttpTestingController;
    let elemDefault: IPhotoRs;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a PhotoRs', async () => {
      ...
      it('should update a PhotoRs', async () => {
        const returnedFromService = Object.assign(
          {
      ...
      it('should return a list of PhotoRs', async () => {
        const returnedFromService = Object.assign(
          {
            originalImage: 'BBBBBB',
            thumbnail: 'BBBBBB',
      ...
      it('should delete a PhotoRs', async () => {
