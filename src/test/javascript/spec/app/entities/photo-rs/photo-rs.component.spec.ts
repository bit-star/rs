...
import { PhotoRsComponent } from 'app/entities/photo-rs/photo-rs.component';
import { PhotoRsService } from 'app/entities/photo-rs/photo-rs.service';
import { PhotoRs } from 'app/shared/model/photo-rs.model';

describe('Component Tests', () => {
  describe('PhotoRs Management Component', () => {
    let comp: PhotoRsComponent;
    let fixture: ComponentFixture<PhotoRsComponent>;
    let service: PhotoRsService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RsTestModule],
        declarations: [PhotoRsComponent],
        providers: [
          {
        ...
        .overrideTemplate(PhotoRsComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PhotoRsComponent);
