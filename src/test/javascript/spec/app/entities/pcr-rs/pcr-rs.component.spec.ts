...
import { PcrRsComponent } from 'app/entities/pcr-rs/pcr-rs.component';
import { PcrRsService } from 'app/entities/pcr-rs/pcr-rs.service';
import { PcrRs } from 'app/shared/model/pcr-rs.model';

describe('Component Tests', () => {
  describe('PcrRs Management Component', () => {
    let comp: PcrRsComponent;
    let fixture: ComponentFixture<PcrRsComponent>;
    let service: PcrRsService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RsTestModule],
        declarations: [PcrRsComponent],
        providers: [
          {
        ...
        .overrideTemplate(PcrRsComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(PcrRsComponent);
