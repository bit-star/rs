...
import { TagRsComponent } from 'app/entities/tag-rs/tag-rs.component';
import { TagRsService } from 'app/entities/tag-rs/tag-rs.service';
import { TagRs } from 'app/shared/model/tag-rs.model';

describe('Component Tests', () => {
  describe('TagRs Management Component', () => {
    let comp: TagRsComponent;
    let fixture: ComponentFixture<TagRsComponent>;
    let service: TagRsService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RsTestModule],
        declarations: [TagRsComponent],
        providers: [
          {
        ...
        .overrideTemplate(TagRsComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(TagRsComponent);
