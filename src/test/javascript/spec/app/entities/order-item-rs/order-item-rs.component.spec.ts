...
import { OrderItemRsComponent } from 'app/entities/order-item-rs/order-item-rs.component';
...
describe('Component Tests', () => {
  describe('OrderItemRs Management Component', () => {
    let comp: OrderItemRsComponent;
    let fixture: ComponentFixture<OrderItemRsComponent>;
    let service: OrderItemRsService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RsTestModule],
        declarations: [OrderItemRsComponent],
        providers: [
          {
        ...
        .overrideTemplate(OrderItemRsComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(OrderItemRsComponent);
