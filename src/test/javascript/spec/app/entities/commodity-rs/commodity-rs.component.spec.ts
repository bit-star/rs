...
import { CommodityRsComponent } from 'app/entities/commodity-rs/commodity-rs.component';
...
describe('Component Tests', () => {
  describe('CommodityRs Management Component', () => {
    let comp: CommodityRsComponent;
    let fixture: ComponentFixture<CommodityRsComponent>;
    let service: CommodityRsService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [RsTestModule],
        declarations: [CommodityRsComponent],
        providers: [
          {
        ...
        .overrideTemplate(CommodityRsComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(CommodityRsComponent);
