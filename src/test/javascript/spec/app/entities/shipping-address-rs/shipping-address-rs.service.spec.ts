...
describe('Service Tests', () => {
  describe('ShippingAddressRs Service', () => {
    let injector: TestBed;
    let service: ShippingAddressRsService;
    let httpMock: HttpTestingController;
    let elemDefault: IShippingAddressRs;
    let expectedResult;
    beforeEach(() => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a ShippingAddressRs', async () => {
        ...
        service
          .create(new ShippingAddressRs(null))
          .pipe(take(1))
          .subscribe(resp => (expectedResult = resp));
      ...
      it('should update a ShippingAddressRs', async () => {
        const returnedFromService = Object.assign(
          {
            receiver: 'BBBBBB',
            moblie: 'BBBBBB',
      ...
      it('should return a list of ShippingAddressRs', async () => {
        const returnedFromService = Object.assign(
          {
            receiver: 'BBBBBB',
            moblie: 'BBBBBB',
      ...
      it('should delete a ShippingAddressRs', async () => {
